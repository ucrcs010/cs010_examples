...
/// @brief Example utilized in class on to discuss
///         the basics of a program and basic output in C++.

// Libraries are included through a #include statement
// Many libraries exist for our use in C++ which include code written 
//  by others for use within our programs. 
// This is the input output stream library.
#include <iostream>

// This line allows us to use defined terms in the standard namespace without
//  continually noting that the terms come from the standard namespace. 
//  Without this line, all our cout keywords would need to be std::cout.
using namespace std;
