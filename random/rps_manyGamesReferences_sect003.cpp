...
// predicate function returns true or false in every case
bool winner(int p1Choice, int p2Choice, bool &p1Wins, bool &p2Wins)
{
...
int main()
{
    ...
    for (int p = 0; p < numGames; p++)
    {
        ...
        do 
        {
            ...
            someoneWon = winner(p1Choice, p2Choice, p1Wins, p2Wins);
            
        } while(!someoneWon); // when there is a tie, go again!
